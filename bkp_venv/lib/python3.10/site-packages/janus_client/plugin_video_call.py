...
class JanusVideoCallPlugin(JanusPlugin):
    ...
    async def on_incoming_call(self, jsep: dict):
        ...
        self.__player = MediaPlayer(
            "/dev/video0",
            format="v4l2",
            options={
                "video_size": "640x480",
            })
        # self.__recorder = MediaRecorder("/home/raufur/janus_workspace/janus_with_python/videocall_in_record.mp4", )
        ...
        await self.accept(jsep=jsep,pc=self.__pc,player=self.__player)
